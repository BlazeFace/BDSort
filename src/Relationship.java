...
public class Relationship {
    ...
    private ArrayList<Trait> finalResults = new ArrayList<>(n);
    ...
    private ArrayList<Trait> finalComp() {
        for (int i = 0; i < n; i++) {
            finalResults.add(new Trait(Kink.types.get(i), compatibility[i]));
        }
        return finalResults;
    }
    ...
    private void returnResults() {
        ...
        System.out.print("Your Most Compatable Trait is" + finalResults.get(13));
    }
